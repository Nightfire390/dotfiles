...
theme.font          = "liberation mono bold 9"-- 8.5"

theme.bg_normal     = "#0c1112"--"#0C1112"--"#0a0a0d"
theme.bg_focus      = "#0c1112"--"#0C1112"--"#0d0d0d"
theme.bg_urgent     = "#dd3355"
...
-- Example:
theme.taglist_bg_focus = "#dd4444"--"#cccccc"--"#dd4444"
...
theme.notification_font = "sans 8.5"

theme.notification_shape = function(cr, width, height)
    return gears.shape.rounded_rect(cr, width, height, 4)  -- Larger radius for more rounded corners
end


-- Variables set for theming the menu:
theme.menu_bg_focus = "#dd4444"--"#cccccc"--"#dd4444"
theme.menu_fg_focus = "#0a0a0a"
theme.menu_border_width = dpi(5)
theme.menu_border_color = "#0C1112"
theme.menu_font = "liberation mono bold 8.5"
...
theme.wallpaper = os.getenv("HOME") .. "/Pictures/Wallpapers/minimal_red.jpg"--futureprototype.png"--fnerf1e326a61.jpg"
